...
export default function HowItWorksClient() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section style={{ 
        background: 'linear-gradient(135deg, rgba(124,58,237,0.15) 0%, rgba(224,64,251,0.15) 100%)',
        color: '#333',
        padding: '4rem 0',
        textAlign: 'center'
      }}>
      ...
      <section style={{ background: 'linear-gradient(90deg, rgba(124,58,237,0.15) 0%, rgba(224,64,251,0.15) 100%)', padding: '5rem 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '1.2rem', opacity: 0.9, color: '#333' }}>
          ...
          <div className="features-grid">
            {[
              ...
              <div key={index} className="feature-card">
                ...
                <p style={{ fontSize: '0.9rem', opacity: 0.9, color: '#333' }}>
                  {tool.desc}
                </p>
              </div>
            ))}
      ...
      {/* Quick Start CTA */}
      <section style={{ background: 'linear-gradient(90deg, rgba(224,64,251,0.15) 0%, rgba(124,58,237,0.15) 100%)', padding: '5rem 0', textAlign: 'center', color: '#333' }}>
        <div className="container">
          <h2 style={{ 
            fontFamily: 'Montserrat', 
            fontSize: '2.5rem', 
